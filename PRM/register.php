      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            ...
            <span class="color-text-a">New Owner</span>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-10 offset-md-1 col-lg-10 offset-lg-1">
          ...
          <div class="form-comments">
            ...
            <form class="form-a" method="post" action="add_details.php">

              <div class="row">
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    <label for="inputName">Enter name</label>
                    <input name="name" type="text" class="form-control form-control-lg form-control-a" id="inputName" placeholder="Name *"
                      required>
                  </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input name="pass" type="password" class="form-control form-control-lg form-control-a" id="inputName" placeholder="Password *"
                      required>
                  </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input name="phno" type="text" class="form-control form-control-lg form-control-a" id="inputName" placeholder="Phone Number *"
                      required>
                  </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    <label for="inputEmail1">Account No.</label>
                    <input name="accno" type="number" class="form-control form-control-lg form-control-a" id="inputEmail1"
                      placeholder="Account No. *" required>
                  </div>
                </div> 

                <div class="col-md-12">
                  <button type="submit" name="register" class="btn btn-a">Register User</button>
                </div>
              </div>
            </form>
