  ...
  <section class="property-grid grid">
    <div class="container">
      <div class="row">
        ...
        <?php
          //<<------------- SEARCHING HOUSES FROM DATABASE --------------------->>
          if(isset($_POST['search']))
          {
            ...
            $query = mysqli_query($connection,"Select * from houses where type='$type' AND town='$town'");
        ...
        <div class="col-md-4">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['img']);?>" alt="Not Available" class="img-a img-fluid">
            </div>
              ...
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="#"><?php echo $row['address'];?>
                      <br /> <?php echo $row['town'];?></a>
                  </h2>
                </div>
                <div class="card-body-a">
                  <?php
                    $query1 = mysqli_query($connection,"Select * from flat where hno=$row[hno]");
                    $row1 = mysqli_fetch_array($query1);
                  ?>
                  <div class="price-box d-flex">
                    <span class="price-a">rent | ₹ <?php echo $row1['rentamount'];?></span>
                  </div>

                <form action="add_details.php" method="POST">
                  <button type="submit" class="btn btn-b-n" name="property">Click here to view
                ...
                <div class="card-footer-a">
                  <ul class="card-info d-flex justify-content-around">
                    <li>
                      <h4 class="card-info-title">House No.</h4>
                    <span>
                      <input type="hidden" name="houseno" value="<?php echo $row['hno'];?>">
                        <?php echo $row['hno'];?>
                      </input>
                    </span>
                    </li>
          ...
          <div class="card-box-a card-shadow">
            ...
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                ...
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">rent | ₹ 7,000</span>
                  </div>
                  <a href="property-single.html" class="link-a">Click here to view
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
          ...
          <div class="card-box-a card-shadow">
            ...
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                ...
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">rent | ₹ 11,000</span>
                  </div>
                  <a href="property-single.html" class="link-a">Click here to view
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
